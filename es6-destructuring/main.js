...
const sentence = `The title of the book is ${title}, the authors is ${author}, and the library id is ${libraryID}.`;
...
const sentenceTwo = `The title of the book is ${title2}, the authors is ${author2}, and the library id is ${id2}.`;
